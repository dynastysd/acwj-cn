...
// 确定变量相对于 .L2 标签的偏移量。是的，这是低效的代码。
static void set_var_offset(int id) {
  int offset = 0;
  // 遍历符号表直到 id。
  // 查找 S_VARIABLE 并每次加 4，
  // 直到找到我们的变量
